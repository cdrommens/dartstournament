...
import be.dcharmonie.dartstournament.library.renderer.image.layout.BracketBoxShape;
import be.dcharmonie.dartstournament.library.renderer.image.layout.LineShape;
